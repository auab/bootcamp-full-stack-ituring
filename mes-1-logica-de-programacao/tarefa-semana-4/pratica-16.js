/*
 criar uma função no arquivo que receba dois parâmetros:
  • a lista de fotos • o termo de busca

Com os dados de entrada fornecidos, retorne os itens 
que correspondem a busca.
*/
...
function filtraFotos(listaFotos,tagChave){
    return listaFotos.filter(foto => foto.tags.includes(tagChave));
  }

console.log(filtraFotos(listaFotos,'cachorro'));